...
SSRF tricks the server into making HTTP requests on your behalf — to internal services, admin panels, or cloud metadata endpoints that are normally inaccessible.
